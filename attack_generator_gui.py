...
from database import init_db, create_user as db_create_user
...
class WAFManagementSuite:
    ...
    def setup_anomaly_testing_tab(self):
        ...
        # Results Display
        results_frame = ttk.LabelFrame(self.anomaly_tab, text="Test Results", padding=10)
    ...
    def setup_user_management_tab(self):
        ...
        # Create User Form
        form_frame = ttk.LabelFrame(self.user_tab, text="Create New User", padding=20)
        ...
        # Buttons
        button_frame = tk.Frame(self.user_tab)
